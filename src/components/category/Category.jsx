...
import { Table, Button, Modal, Form, Input, Space, Image, Upload, ConfigProvider, Alert } from 'antd';
import { FaPlus, FaEdit, FaTrash } from 'react-icons/fa';
import { CloseCircleOutlined, CloudUploadOutlined, ExclamationCircleOutlined } from '@ant-design/icons';
...
const CategoryList = () => {
  ...
  const handleImageUpload = (info) => {
    if (info.file.status === 'done') {
      // In a real app, you would handle the uploaded file
  ...
  // Mock function for image upload (in a real app, you would connect to your backend)
